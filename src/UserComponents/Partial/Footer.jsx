...
import { getNewsletter, createNewsletter } from '../../Redux/ActionCreator/NewsletterActionCreator'
...
export default function Footer() {
    ...
    function postData(e) {
        ...
        if (item) {
            toast.error("Email already register with us!", {
                position: "top-right",
                autoClose: 2000,
            });
        }
                        ...
                        <div className="row g-4">
                            ...
                            <div className="col-lg-6">
                                <div className="position-relative mx-auto">
                                    <input className="form-control border-0 w-100 py-3 px-4 rounded-pill" onChange={(e) => setEmail(e.target.value)} type="email" name='email' value={email} placeholder="Your Email" />
                                    
                                    <button onClick={postData} type="submit" className="btn btn-info border-2 border-info py-3 px-4 position-absolute rounded-pill text-white" style={{ height: "57px", top: " 0", right: "0" }}>Subscribe Now</button>
                                    <ToastContainer/>
