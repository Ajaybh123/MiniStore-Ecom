...
export default function ShopDetailContent() {
    const option = {
        responsive:{
                0: {
                    items:1
                    ...
                    <div className="col-lg-8 col-xl-9">
                        <div className="row g-4">
                            ...
                            <div className="col-lg-6">
                                ...
                                <a href="#" className="btn border border-info rounded-pill px-4 py-2 mb-4 text-info"><i className="fa fa-shopping-bag me-2 text-info"></i> Add to cart</a>
                            </div>
      ...
      /                                 <div className="position-absolute" style={{top: "50%", right:" 10px", transform: "translateY(-50%)"}}>
                ...
                <div className="vesitable">
                    <div className="vegetable-carousel justify-content-center">
                        ...
                        <div className="border border-dark ms-2 rounded position-relative vesitable-item">
                            ...
                            <div className="p-4 pb-0 rounded-bottom">
                                ...
                                <div className="d-flex justify-content-between flex-lg-wrap">
                                    ...
                                    <a href="#" className="btn border border-info rounded-pill px-3 py-1 mb-4 text-info"><i className="fa fa-shopping-bag me-2 text-info"></i> Add to cart</a>
                                </div>
                            </div>
                        </div>
                        <div className="border border-dark ms-2 rounded position-relative vesitable-item">
