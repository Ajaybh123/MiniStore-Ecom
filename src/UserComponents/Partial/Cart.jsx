            ...
            <div className="container mt-4">
                <div className="row">
                    <div className="col-md-8">
                        <div className="testimonial-item ms-2 img-border-radius shadow bg-light rounded p-4 mb-3">
                            {
                                cart.length ?
                                    cart.map((item, index) => {
                                        return <> <div key={index} className="row">
                                            <div className="col-md-4">
                                                ...
                                                <div className="d-flex gap-2 align-items-center m-3 quantity mb-4" >
                                            ...
                                            <div className='col-md-8'>
                                                <div className='d-flex justify-content-between'>
                                                    <div><h6>{item.name}</h6>
                                                        ...
                                                        <p className='btn text-danger' onClick={() => deleteItem(item.id)}><i className='fa fa-trash'></i> Remove</p>
                                                    </div>
                                                    <div>
                    ...
                    </div>
                    {
                        cart.length?
                        <div className="col-md-4">
                        <div className="testimonial-item ms-2 img-border-radius shadow bg-light pb-2 rounded">
                            ...
                            <div className='px-4'>
                                ...
                                <button className='btn btn-info w-100 mt-1'>Process To Checkout</button>
                            </div>
                        </div>
                    </div>:""
                    }
